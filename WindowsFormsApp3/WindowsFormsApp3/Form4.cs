...
namespace WindowsFormsApp3
{
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {   
                string connectionString = "Data Source=DESKTOP-O7DEG44\\SQLEXPRESS;Initial Catalog=Garage;Integrated Security=True;Encrypt=False";
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    if (int.TryParse(textBox1.Text, out int idValue))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand("INSERT INTO Employes (Nom, Prenom, Poste, Salaire) VALUES (@Nom, @Prenom, @Poste, @Salaire)", connection))
                        {
        ...
        private void Enregistrer_Click(object sender, EventArgs e)
        {
            ...
            if (decimal.TryParse(textBox4.Text, out salaire))
            {
                ...
                using (SqlConnection connection = new SqlConnection("Data Source=DESKTOP-O7DEG44\\SQLEXPRESS;Initial Catalog=Garage;Integrated Security=True;Encrypt=False"))
                {
                    connection.Open();
